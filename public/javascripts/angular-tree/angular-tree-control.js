        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', function( $scope ) {
                    ...
                    $scope.addClassNode = function( node ){
                        if (node.type == 'file') {
                            if (node.mime == 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'){
                                return 'application-msword';
                            }
                            return node.mime.replace("/", "-");
                        }
                    };                    
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<i class="tree-leaf-head '+classIfDefined($scope.options.injectClasses.iLeaf, false)+'" ng-class=addClassNode(node)></i>' +
